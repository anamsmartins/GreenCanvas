...
class DP_OT_building_plant_operator(BL_UI_OT_draw_operator):
    bl_idname = "view3d.dp_ot_building_plant_operator"
    bl_label = "Blender UI building plant panel operator"
    bl_description = "Blender UI building plant panel operator" 
    bl_options = {'REGISTER'}
    ...
    def on_invoke(self, context, event):
        ...
        image_path = os.path.join(addon_root, "images", "gc_building_plant.png")
