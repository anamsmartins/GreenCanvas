...
PANEL_BOUNDS = {"x": 0, "y": 0, "width": 350, "height": 500}

class DP_OT_instructions_info_operator(BL_UI_OT_draw_operator):
    bl_idname = "view3d.dp_ot_instructions_info_operator"
    bl_label = "Blender UI instructions information panel operator"
    bl_description = "Blender UI instructions information panel operator" 
    bl_options = {'REGISTER'}
    ...
    def on_invoke(self, context, event):
        ...
        image_path = os.path.join(addon_root, "images", "gc_instructions_info.png")
...
classes = (
    DP_OT_instructions_info_operator,
)
